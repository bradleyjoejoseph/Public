...
//            string num1name = Console.ReadLine();
//            Console.WriteLine("Player two name: ");
//            string num2name = Console.ReadLine();
//            player1 = new Player(num1name, 0, 10, 10, 5);
//            player2 = new Player(num2name, 1, 10, 10, 5);
//            grid.SetUpGridTerrain(t);
//            grid.AddPiece(true, "Baron", 0);
//            grid.AddPiece(true, "Serf", 8);
...
//                        if (thePiece.GetBelongsToPlayer1())
//                        {
//                            Player1.AddToPiecesInSupply(1);
//                            player2VPs += thePiece.GetVPs();
//                        }
//                        else
//                        {
//                            Player2.AddToPiecesInSupply(1);
//                            player1VPs += thePiece.GetVPs();
//                        }
//                    }
//                }
...
//        public virtual void AddToPiecesInSupply(int n)
//        {
//            piecesInSupply += n;
//        }
